...
public:
    int findCrossingTime(int n, int k, vector<vector<int>>& time) {
        ...
        {
            //若work_left或work_right中的工人完成工作,则将他们取出,并分别放置到wait_left和wait_right中
            ...
            {
                //若右侧还有箱子,并且左侧有工人在等待,则取出优先级最低的工人并过桥
            ...
            {
                //否则,没有人需要过桥,时间过渡到work_left和work_right中的最早完成时间
